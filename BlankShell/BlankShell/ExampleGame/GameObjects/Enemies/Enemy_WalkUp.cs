//------------------------------------------------------------------------------
// File: GreenBug_WalkUp.cs
// Author: Neil Holmes & Andrew Green
// Summary: Green Bug's walk up state
//------------------------------------------------------------------------------
...
{
    //------------------------------------------------------------------------------
    // Class: GreenBug_WalkUp
    // Author: Neil Holmes & Andrew Green
    // Summary: Green Bug's walk up functionality
    //------------------------------------------------------------------------------
    public class GreenBug_WalkUp : GameObjectState
    {
        // reference to the green bug that owns this state
        private GreenBug parent;

        //------------------------------------------------------------------------------
        // Constructor: GreenBug_WalkUp
        // Author: Neil Holmes & Andrew Green
        // Summary: state constructor
        //------------------------------------------------------------------------------
        public GreenBug_WalkUp(GameObject2D parent)
            : base(parent)
        {
        ...
        public override void Enter()
        {
            ...
            parent.SetAnimation((int)EnemyAnimation.walkUp);
        }
