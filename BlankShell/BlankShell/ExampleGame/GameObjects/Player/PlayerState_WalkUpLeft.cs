//------------------------------------------------------------------------------
// File: PlayerState_WalkUpLeft.cs
// Author: Neil Holmes & Andrew Green
// Summary: player's walk up left state
//------------------------------------------------------------------------------
...
{
    //------------------------------------------------------------------------------
    // Class: PlayerState_WalkUpLeft
    // Author: Neil Holmes & Andrew Green
    // Summary: player's walk up left functionality
    //------------------------------------------------------------------------------
    public class PlayerState_WalkUpLeft : GameObjectState
    {
        // reference to the player object that owns this state
        Player player;

        //------------------------------------------------------------------------------
        // Constructor: PlayerState_WalkUpLeft
        // Author: Neil Holmes & Andrew Green
        // Summary: state constructor
        //------------------------------------------------------------------------------
        public PlayerState_WalkUpLeft(GameObject2D parent)
            : base(parent)
        {
        ...
        public override void Enter()
        {
            ...
            player.SetAnimation((int)PlayerAnimation.walkUpLeft);
