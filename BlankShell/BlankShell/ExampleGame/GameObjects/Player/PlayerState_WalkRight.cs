//------------------------------------------------------------------------------
// File: PlayerState_WalkRight.cs
// Author: Neil Holmes & Andrew Green
// Summary: player's walk right state
//------------------------------------------------------------------------------
...
{
    //------------------------------------------------------------------------------
    // Class: PlayerState_WalkRight
    // Author: Neil Holmes & Andrew Green
    // Summary: player's walk right functionality
    //------------------------------------------------------------------------------
    public class PlayerState_WalkRight : GameObjectState
    {
        // reference to the player object that owns this state
        Player player;

        //------------------------------------------------------------------------------
        // Constructor: PlayerState_WalkRight
        // Author: Neil Holmes & Andrew Green
        // Summary: state constructor
        //------------------------------------------------------------------------------
        public PlayerState_WalkRight(GameObject2D parent) : base(parent) 
        {
        ...
        public override void Enter() 
        {
            ...
            player.SetAnimation((int)PlayerAnimation.walkRight);
