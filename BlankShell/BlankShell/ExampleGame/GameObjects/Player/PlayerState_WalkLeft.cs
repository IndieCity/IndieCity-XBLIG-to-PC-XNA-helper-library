...
{
    //------------------------------------------------------------------------------
    // Class: PlayerState_WalkLeft
    // Author: Neil Holmes & Andrew Green
    // Summary: player's walk left functionality
    //------------------------------------------------------------------------------
    public class PlayerState_WalkLeft : GameObjectState
    {
        ...
        //------------------------------------------------------------------------------
        public PlayerState_WalkLeft(GameObject2D parent)
            : base(parent)
        {
        ...
        public override void Enter()
        {
            ...
            player.SetAnimation((int)PlayerAnimation.walkLeft);
