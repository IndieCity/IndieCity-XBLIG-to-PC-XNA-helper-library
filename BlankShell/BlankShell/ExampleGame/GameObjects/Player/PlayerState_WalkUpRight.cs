//------------------------------------------------------------------------------
// File: PlayerState_WalkUpRight.cs
// Author: Neil Holmes & Andrew Green
// Summary: player's walk up right state
//------------------------------------------------------------------------------
...
{
    //------------------------------------------------------------------------------
    // Class: PlayerState_WalkUpRight
    // Author: Neil Holmes & Andrew Green
    // Summary: player's walk up right functionality
    //------------------------------------------------------------------------------
    public class PlayerState_WalkUpRight : GameObjectState
    {
        // reference to the player object that owns this state
        Player player;

        //------------------------------------------------------------------------------
        // Constructor: PlayerState_WalkUpRight
        // Author: Neil Holmes & Andrew Green
        // Summary: state constructor
        //------------------------------------------------------------------------------
        public PlayerState_WalkUpRight(GameObject2D parent)
            : base(parent)
        {
        ...
        public override void Enter()
        {
            ...
            player.SetAnimation((int)PlayerAnimation.walkUpRight);
