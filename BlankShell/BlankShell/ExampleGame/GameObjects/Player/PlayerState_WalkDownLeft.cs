//------------------------------------------------------------------------------
// File: PlayerState_WalkDownLeft.cs
// Author: Neil Holmes & Andrew Green
// Summary: player's walk down left state
//------------------------------------------------------------------------------
...
{
    //------------------------------------------------------------------------------
    // Class: PlayerState_WalkDownLeft
    // Author: Neil Holmes & Andrew Green
    // Summary: player's walk down left functionality
    //------------------------------------------------------------------------------
    public class PlayerState_WalkDownLeft : GameObjectState
    {
        // reference to the player object that owns this state
        Player player;

        //------------------------------------------------------------------------------
        // Constructor: PlayerState_WalkDownLeft
        // Author: Neil Holmes & Andrew Green
        // Summary: state constructor
        //------------------------------------------------------------------------------
        public PlayerState_WalkDownLeft(GameObject2D parent)
            : base(parent)
        {
        ...
        public override void Enter()
        {
            ...
            player.SetAnimation((int)PlayerAnimation.walkDownLeft);

            // set the animation speed to the default speed
            player.AnimationSpeed = player.DefaultAnimationSpeed;
        }
